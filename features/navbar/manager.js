...
export default function Manager() {
  ...
  const [openDialog, setOpenDialog] = React.useState(false); // State to track dialog open status
  ...
  const handleCloseNavMenu = (page) => {
    setAnchorElNav(null);
    if (page === 'Add Product') {
      setOpenDialog(true); // Open dialog if Add Product is selected
    } else {
      setCurrentPage(page); // Update currentPage when a menu item is clicked
    }
  };
